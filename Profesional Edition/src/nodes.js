...
const likedPreviewSection = document.querySelector("#likedPreview");
...
const likedMoviesPreviewList = document.querySelector(".likedPreview-movieList");
...
const likedPreviewBtn = document.querySelector(".likedPreview-btn");
